...
export function SirohiMarketplace() {
  ...
  return (
    <main className="digital-universe" id="universe">
      <AnimatePresence>
        {loading ? (
          <motion.div className="brand-splash" exit={{ opacity: 0, scale: 1.025 }} transition={{ duration: 0.55, ease: "easeInOut" }}>
            <div className="brand-splash__grain" aria-hidden="true" />
            <div className="brand-splash__content">
              <div className="brand-splash__mark-wrap">
                <span className="brand-splash__glow" aria-hidden="true" />
                <img className="brand-splash__mark" src="/splash-mark.png" alt="Sirohi Point" />
                <span className="brand-splash__shine" aria-hidden="true" />
              </div>
              <img className="brand-splash__wordmark" src="/splash-wordmark.png" alt="Sirohi Point" />
              <img className="brand-splash__tagline" src="/splash-tagline.png" alt="Hardware, electronics and paint" />
            </div>
          </motion.div>
        ) : null}
      </AnimatePresence>
