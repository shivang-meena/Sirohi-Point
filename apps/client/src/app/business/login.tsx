...
export default function BusinessLoginScreen() {
  ...
  return <View style={styles.page}><View style={styles.topbar}><Pressable accessibilityRole="link" accessibilityLabel="Back to role selection" onPress={() => router.replace('/')}><Text style={styles.brand}>SIROHI POINT <Text style={styles.brandAccent}>BUSINESS</Text></Text></Pressable><Text style={styles.label}>B2B PROCUREMENT</Text></View><View style={styles.body}><AuthPanel mode="business" /></View></View>;
}
